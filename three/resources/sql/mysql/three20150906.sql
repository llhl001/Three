...
INSERT INTO `sys_dictionary` VALUES ('2', '1', '用户1', '2', '0', '0', '1');
INSERT INTO `sys_dictionary` VALUES ('3', '2', '普通员工01', '2', '0', '0', '1');
...
CREATE TABLE `sys_organization` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='组织机构';
...
INSERT INTO `sys_organization` VALUES ('4', '11', '11', '11', 'icon_folder', null, '0', '2015-09-06 09:46:53');
INSERT INTO `sys_organization` VALUES ('5', '12修改', '0000000000', '112', 'icon_folder', '1', '0', '2015-09-06 09:47:02');
...
CREATE TABLE `sys_resource` (
  ...
  `createdatetime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='资源';
...
INSERT INTO `sys_resource` VALUES ('38', '商品类别', '/category/manager', '类别管理', 'icon_dic', '63', '1', '0', '0', '2014-02-19 01:00:00');
INSERT INTO `sys_resource` VALUES ('39', '商品管理', '/goods/manager', '商品管理', 'icon_dic', '63', '1', '0', '0', '2014-02-19 01:00:00');
INSERT INTO `sys_resource` VALUES ('40', '供应商管理', '/supplier/manager', '供应商管理', 'icon_dic', '63', '1', '0', '0', '2014-02-19 01:00:00');
INSERT INTO `sys_resource` VALUES ('43', '客户管理', '/customer/manager', '客户管理', 'icon_dic', '63', '1', '0', '0', '2014-02-19 01:00:00');
...
INSERT INTO `sys_resource` VALUES ('63', '基础数据', '', '包括：商品管理、供应商管理、会员管理', 'icon_sys', null, '0', '0', '0', '2015-09-06 10:52:25');
...
INSERT INTO `sys_user` VALUES ('3', 'gch', '宫传华', 'e10adc3949ba59abbe56e057f20f883e', '0', '26', '1', '1', '0', '2', '2015-09-06 10:35:51');
