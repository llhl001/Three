	...
	<div id="index_layout">
		...
		<div data-options="region:'center'" style="overflow: hidden;">
			<div id="index_tabs" style="overflow: hidden;">
				<div title="首页" data-options="border:false" style="overflow: hidden;background:url('${ctx}/style/images/yuebing.jpg') ">
					<%-- <img alt="2015" src="${ctx}/style/images/2015-02.jpg"> --%>
				</div>
			</div>
		</div>
		<div data-options="region:'south',border:false" style="height: 30px; overflow: hidden;text-align: center;background-color: #daeef5" >developer:Skywalker </div>
	</div>
